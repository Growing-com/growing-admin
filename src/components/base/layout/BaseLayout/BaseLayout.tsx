...
const BaseLayout: FC<tBaseLayout> = ({ children }) => {
  ...
  const onSelectMenu = useCallback(
    async (info: tSelectInfo) => {
      ...
      console.log('selectedSubMenu',info.key);
    ...
    <Layout style={{ minHeight: "100vh" }}>
      ...
      <Layout>
        ...
        >
          ...
          />
          <button onClick={()=> console.log(defaultOpen)}>defaultOpen</button>
          <button onClick={()=> console.log(selectedSubMenu)}>selectedSubMenu</button>
        </Sider>
        <Layout>
