...
const useSmallGroupMutate = (onClickClose: () => void) => {
  ...
  const { mutateAsync: createSmallGroupMutate } = useMutation(createSmallGroup, {
  ...
  const { mutateAsync: updateSmallGroupMutate } = useMutation(updateSmallGroup, {
  ...
  const { mutateAsync: deleteSmallGroupMutate } = useMutation(deleteSmallGroup, {
  ...
  return { createSmallGroupMutate, updateSmallGroupMutate, deleteSmallGroupMutate };
};
